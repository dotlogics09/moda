        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="white_box mb_30">
                    ...
                    <form action="{{url('product/update_product')}}/{{$edit_data->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="exampleFormControlInput1">Product Name</label>
                                <input type="text" class="form-control" name="product_name" value="{{$edit_data->product_name}}" id="" placeholder="Enter the Product Name">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="subcategory" id="subcategory-drop">
                                    ...
                                    <option value="{{$subcat->id}}" {{$subcat->id == $edit_data->subcategory_id ? 'selected' : ''}}>{{$subcat->subcategory_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="price" value="{{$edit_data->price}}" id="" placeholder="Enter the Price">
                                @if ($errors->has('price'))
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="discount" value="{{$edit_data->discount}}" id="" placeholder="Enter the Discount">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="discount_type">
                                    ...
                                    <option value="amount" {{$edit_data->discount_type == 'amount' ? 'selected' : ''}}>Amount</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="product_image" value="{{$edit_data->product_image}}" id="inputGroupFile02">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="product_description" value="{{$edit_data->product_description}}" id="inputGroupFile02">
